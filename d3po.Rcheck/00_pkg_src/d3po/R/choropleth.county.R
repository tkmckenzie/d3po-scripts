...
#' @param state.column Name of column containing state names. Defaults to "state". All values in this column must match d3po::us.counties$state.
#' @param county.column Name of column containing county names. Defaults to "county". All values in this column must match d3po::us.counties$county.
#' @param id.column Name of column containing identifiers for states/counties. Defaults to "id". All values in this column must match d3po::us.counties$id.
