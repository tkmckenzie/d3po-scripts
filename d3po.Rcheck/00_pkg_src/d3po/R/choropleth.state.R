...
#' @param state.column Name of column containing state names. Defaults to "state". All values in this column must match c(datasets::state.name, "District of Columbia").
